...
#The spread of the data is uneven, suggesting that the distribution is not symmetric.
...
# The points beyond the whiskers suggest the presence of outliers with unusually high crime rates.
